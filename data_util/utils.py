...
def write_for_rouge(original_articles, reference_sents, decoded_words, ex_index,
                    _rouge_ref_dir, _rouge_dec_dir, _rouge_art_dir):
  decoded_sents = []
  ...
  art_file = os.path.join(_rouge_art_dir, "%06d_article.txt" % ex_index)
